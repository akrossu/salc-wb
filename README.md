> [!IMPORTANT]
> The dataset "SONY_IMX135" produced by [INTEL-TAU](https://arxiv.org/abs/1910.10404) is not included in the repository due to its size of 2.33 GB. It is avaliable to download [here](https://etsin.fairdata.fi/dataset/f0570a3f-3d77-4f44-9ef1-99ab4878f17c/data).
...
2. [Download](https://etsin.fairdata.fi/dataset/f0570a3f-3d77-4f44-9ef1-99ab4878f17c/data) and Extract the contents of the Sony_IMX135 zip into the root folder of the project
```
.
├── Sony_IMX135/
|   ├── field_3_cameras/
